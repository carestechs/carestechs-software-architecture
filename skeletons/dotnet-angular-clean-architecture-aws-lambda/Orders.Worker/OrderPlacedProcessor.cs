...
/// <summary>Shared message-processing core for both execution paths (Lambda and
/// dev polling). Restores the correlation id into the log scope before any
    ...
    ILogger<OrderPlacedProcessor> logger)
{
    ...
    /// (drives partial-batch failure reporting).</returns>
