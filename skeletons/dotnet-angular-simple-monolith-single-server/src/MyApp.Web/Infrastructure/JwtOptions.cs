...
/// <summary>Signing configuration for issuance and validation (adrs/api/jwt-bearer-auth.md).</summary>
public sealed class JwtOptions
{
    ...
    /// <summary>Local development only; production injects JWT_SECRET.</summary>
