...
- Mocking only at system boundaries (AI SDK, GitHub API, git CLI, filesystem) ensures tests verify real logic, not mocked logic. Internal function-to-function calls are tested through their natural call chains.
...
- Mock ONLY at system boundaries: AI SDK calls, GitHub API calls, git/child_process calls, filesystem I/O.
